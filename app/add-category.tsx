...
const COMMON_ICONS = ['MapPin', 'Car', 'ShoppingCart', 'Film', 'Coffee', 'Fuel', 'DollarSign', 'Gamepad2', 'Plane', 'Home', 'Book', 'Shirt'];
                ...
                <View className="flex-row flex-wrap mb-6">
                    {COMMON_ICONS.map(ic => (
                        <TouchableOpacity
                            ...
                            onPress={() => setIcon(ic)}
                        >
                            <CategoryIcon name={ic} size={24} color={icon === ic ? "#c7d2fe" : "#a1a1aa"} />
                        </TouchableOpacity>
                    ))}
                </View>
